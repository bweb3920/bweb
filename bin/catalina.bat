...
rem   Registry, and is most conveniently maintained using the "amplix.exe"
...
:emptyClasspath
set "CLASSPATH=%CATALINA_HOME%\bin\amplix_launcher-4.1.0.jar;%CATALINA_HOME%\bin\amplix-4.1.0.jar;%CATALINA_HOME%\lib\slf4j-api-1.7.25.jar;%CATALINA_HOME%\lib\logback-core-1.2.3.jar;%CATALINA_HOME%\lib\logback-classic-1.2.3.jar;%CATALINA_HOME%\lib\tomcat-embed-core-9.0.36.jar;%CATALINA_HOME%\lib\tomcat-annotations-api-9.0.36.jar;%CATALINA_HOME%\lib\tomcat-api-9.0.36.jar;%CATALINA_HOME%\lib\tomcat-el-api-9.0.36.jar;%CATALINA_HOME%\lib\tomcat-embed-core-9.0.36.jar;%CATALINA_HOME%\lib\tomcat-embed-el-9.0.36.jar;%CATALINA_HOME%\lib\tomcat-embed-jasper-9.0.36.jar;%CATALINA_HOME%\lib\tomcat-jasper-9.0.36.jar;%CATALINA_HOME%\lib\tomcat-jasper-el-9.0.36.jar;%CATALINA_HOME%\lib\tomcat-jsp-api-9.0.36.jar;%CATALINA_HOME%\lib\joda-time-2.9.9.jar;%CATALINA_HOME%\lib\commons-codec-1.11.jar;%CATALINA_HOME%\lib\jackson-databind-2.11.0.jar;%CATALINA_HOME%\lib\jackson-core-2.11.0.jar;%CATALINA_HOME%\lib\jackson-annotations-2.11.0.jar;%CATALINA_HOME%\lib\javax.servlet-api-3.1.0.jar;%CATALINA_HOME%\lib\ecj-4.6.1.jar;%CATALINA_HOME%\lib\javax.annotation-api-1.2.jar;%CATALINA_HOME%\lib\tomcat-websocket-9.0.36.jar;%CATALINA_HOME%\lib\javax.websocket-api-1.1.jar;%CATALINA_HOME%\lib\tomcat-catalina-ha-9.0.36.jar;%CATALINA_HOME%\lib\tomcat-tribes-9.0.36.jar"
...
set "JAVA_OPTS=%JAVA_OPTS% -Djava.protocol.handler.pkgs=org.apache.catalina.webresources -Djava.awt.headless=true"
...
%_EXECJAVA% %CATALINA_LOGGING_CONFIG% %LOGGING_MANAGER% %JAVA_OPTS% %CATALINA_OPTS% %DEBUG_OPTS% -D%ENDORSED_PROP%="%JAVA_ENDORSED_DIRS%" -classpath "%CLASSPATH%" -Dcatalina.base="%CATALINA_BASE%" -DAPP_HOME="%CATALINA_HOME%" -Dcatalina.home="%CATALINA_HOME%" -Djava.io.tmpdir="%CATALINA_TMPDIR%" %MAINCLASS% %CMD_LINE_ARGS% %ACTION%
goto end
:doSecurity
%_EXECJAVA% %CATALINA_LOGGING_CONFIG% %LOGGING_MANAGER% %JAVA_OPTS% %CATALINA_OPTS% %DEBUG_OPTS% -D%ENDORSED_PROP%="%JAVA_ENDORSED_DIRS%" -classpath "%CLASSPATH%" -Djava.security.manager -Djava.security.policy=="%SECURITY_POLICY_FILE%" -Dcatalina.base="%CATALINA_BASE%" -DAPP_HOME="%CATALINA_HOME%" -Dcatalina.home="%CATALINA_HOME%" -Djava.io.tmpdir="%CATALINA_TMPDIR%" %MAINCLASS% %CMD_LINE_ARGS% %ACTION%
goto end
:doJpda
if not "%SECURITY_POLICY_FILE%" == "" goto doSecurityJpda
%_EXECJAVA% %CATALINA_LOGGING_CONFIG% %LOGGING_MANAGER% %JAVA_OPTS% %JPDA_OPTS% %CATALINA_OPTS% %DEBUG_OPTS% -D%ENDORSED_PROP%="%JAVA_ENDORSED_DIRS%" -classpath "%CLASSPATH%" -Dcatalina.base="%CATALINA_BASE%" -DAPP_HOME="%CATALINA_HOME%" -Dcatalina.home="%CATALINA_HOME%" -Djava.io.tmpdir="%CATALINA_TMPDIR%" %MAINCLASS% %CMD_LINE_ARGS% %ACTION%
goto end
:doSecurityJpda
