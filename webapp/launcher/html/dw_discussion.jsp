			                    ...
			                    <div class="ibox">
			                        <div class="ibox-title">
			                            ...
			                            <div class="ibox-tools">
			                                <a href="" id="btn_write" class="btn btn-primary btn-xs">$L_WRITE_BBS$</a>
			                            </div>
			                        </div>
			                        <div class="ibox-content">
			                            <div class="row m-b-sm m-t-sm">
			                                <div class="col-md-1">
			                                    <button type="button" id="btn_refresh" class="btn btn-white btn-sm" ><i class="fa fa-refresh"></i> Refresh</button>
			                                </div>
			                                <div class="col-md-11">
